...
export type DataViewCategoriesItem = {
    /**
     * Name
     */
    name?: Label;
    ...
    iconClass?: Label;
    /**
     * Parent Category: ID of the resource by default OR *on demand* JSON object of type [DataViewCategories](#operation/getOneDataViewCategories)
     */
    parentCategory?: (DataViewCategoriesId | DataViewCategoriesItem);
    /**
     * Owner: ID of the resource by default OR *on demand* JSON object of type [Employees](#operation/getOneEmployees)
     */
