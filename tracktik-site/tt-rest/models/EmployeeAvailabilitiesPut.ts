...
export type EmployeeAvailabilitiesPut = {
    /**
     * Week Day
     */
    weekDay: EmployeeAvailabilitiesPut.weekDay;
    /**
     ...
     */
    available: EmployeeAvailabilitiesPut.available;
    /**
     * Status
     */
    status: EmployeeAvailabilitiesPut.status;
}

export namespace EmployeeAvailabilitiesPut {
