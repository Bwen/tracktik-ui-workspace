...
export type PayrollSchedulesPost = {
    /**
     * Name
     */
    name: string;
     ...
     * Frequency
     */
    frequency?: PayrollSchedulesPost.frequency;
    /**
     ...
     * Status
     */
    status: PayrollSchedulesPost.status;
    /**
     * This field was deprecated in favor of `overlappingStrategy`.
     */
    overlapingStrategy: PayrollSchedulesPost.overlapingStrategy;
    /**
     * Period Overlapping Strategy
     */
    overlappingStrategy: PayrollSchedulesPost.overlappingStrategy;
    /**
     * This field was deprecated in favor of `holidayOverlappingStrategy`.
     */
    holidayOverlapingStrategy: PayrollSchedulesPost.holidayOverlapingStrategy;
    /**
     * Holiday Overlapping Strategy
     */
    holidayOverlappingStrategy: PayrollSchedulesPost.holidayOverlappingStrategy;
    /**
     ...
     */
    multiplePayCodesStrategy?: PayrollSchedulesPost.multiplePayCodesStrategy;
}

export namespace PayrollSchedulesPost {
