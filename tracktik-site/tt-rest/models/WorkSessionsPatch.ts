...
export type WorkSessionsPatch = {
     ...
     */
    initiationMethod?: WorkSessionsPatch.initiationMethod;
    /**
     * The method used to clock-in
     */
    clockInMethod?: WorkSessionsPatch.clockInMethod;
    /**
     * This field is deprecated in favor of `clockOutMethod`
     */
    terminationMethod?: WorkSessionsPatch.terminationMethod;
    /**
     * The method used to clock-out
     */
    clockOutMethod?: WorkSessionsPatch.clockOutMethod;
    /**
     * Status
     */
    status?: WorkSessionsPatch.status;
    /**
     * Employee
     */
...
export namespace WorkSessionsPatch {
